...
TEST_CASE("RTCTime math") {
    ...
    SECTION("Addition") {
        ...
        REQUIRE(temp2.getTotalSeconds() + temp3.getTotalSeconds() == 1830);
        REQUIRE(temp3.getTotalSeconds() + temp4.getTotalSeconds() == 37800);
        REQUIRE(temp4.getTotalSeconds() + temp5.getTotalSeconds() == 2196000);
        REQUIRE(temp5.getTotalSeconds() + temp6.getTotalSeconds() == 12614400);
        REQUIRE(temp6.getTotalSeconds() + temp7.getTotalSeconds() == 1525219200);
        REQUIRE(temp7.getTotalSeconds() + temp8.getTotalSeconds() == 1549547784);
    }
